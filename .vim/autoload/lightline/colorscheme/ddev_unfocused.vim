" =============================================================================
" Filename: autoload/lightline/colorscheme/ddev_unfocused.vim
" Author: Erik Lutz
" =============================================================================
...
let s:p.normal.middle = [ [ $COLOR_20, $COLOR_19 ] ]
...
let g:lightline#colorscheme#ddev_unfocused#palette = lightline#colorscheme#fill(s:p)
